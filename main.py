...
from PyQt5.QtWidgets import QFileDialog, QMainWindow, QApplication, QDesktopWidget
...
class cssden(QMainWindow):
    def __init__(self):
        ...
        self.setMaximumSize(QtCore.QSize(700, 180))
        ...
        self.frame.setGeometry(9, 9, 682, 162)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resource_path("icons8-macos-close-96.png")),
        ...
        self.minButton.setGeometry(QtCore.QRect(615, 10, 31, 21))
        self.minButton.setStyleSheet("QPushButton{border-radius:0px;border: 0px solid #345781;}")
        self.minButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resource_path("icons8-macos-minimize-96 (1).png")),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
